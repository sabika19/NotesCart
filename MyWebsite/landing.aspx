<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="landing.aspx.cs" Inherits="MyWebsite.landing" %>
...
<section class="engine"><a rel="nofollow" href="https://mobirise.com">Mobirise website design software mac
</a></section>
<section class="mbr-navbar mbr-navbar--freeze mbr-navbar--absolute mbr-navbar--transparent mbr-navbar--sticky mbr-navbar--auto-collapse" id="ext_menu-8">
            ...
            <div class="mbr-navbar__container">
                <div class="mbr-navbar__column mbr-navbar__column--s mbr-navbar__brand">
                    <span class="mbr-navbar__brand-link mbr-brand mbr-brand--inline">
                        <span class="mbr-brand__logo"><a href="index.html"><img class="mbr-navbar__brand-img mbr-brand__img" src="img/onlinelogomaker-042516-1245.png" alt=""></a></span>
                        <span class="mbr-brand__name"><a class="mbr-brand__name text-danger" href="index.html"></a></span>
                    </span>
                </div>
  ...
  <!--  <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
      ...
      <!--      <div class="navbar-header">
                ...
                <a class="navbar-brand topnav" href="#"><img  src="img/onlinelogomaker-042516-1245.png" alt=""></a>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="intro-message">
                        <h1>NOTES CART</h1>
                        <h3>A One Stop solution To All Your Study Material Needs</h3>
					<div align="center">
...
<input type="text" color="black" name="zoom_query" style="width:200px; border:0px solid; height:20px; padding:0px 3px; position:relative;"> 
</td>
<td style="border-style:solid;border-color:#4B7B9F;border-width:0px;height: 30px;"> 
